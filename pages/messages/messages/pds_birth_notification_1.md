...
The following requirements and resource population guidance should be followed in addition to the requirements and guidance outlined in the event message [Generic Requirements](explore_genreic_event_requirements.html) page, but any differences in the guidance and requirements on this page take precedence.
...
{% include warning.html content="Cardinalities of the `routingDemographics` extension are different to the requirements within the event message [Generic Requirements](explore_genreic_event_requirements.html) page." %}
...
{% include warning.html content="Cardinalities within this resource are different to the requirements within the event message [Generic Requirements](explore_genreic_event_requirements.html) page." %}
