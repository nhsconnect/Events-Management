...
| InteractionID | Value: `urn:nhs:names:services:events:[Event_Code].Write`<br/><br/>The **[Event_Code]** SHALL match the event code within table on the [Supported Event Messages](overview_supported_events.html#event-messages) page. |
