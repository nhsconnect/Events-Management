...
## Experimental ##
This Experimental version includes implementation guidance to support the developments of the following aspects of the Events Management Service:

- generic event header items
- National Failsafe Alert event message
