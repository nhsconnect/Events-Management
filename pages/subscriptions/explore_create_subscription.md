...
| Organization.identifier=[CODE] | 1..1 | The [CODE] is the ODS code for the publishing organisation, for example: <br/>`https://fhir.nhs.uk/Id/ods-organization-code|[ODSCode]` |
