...
| A child health service subscribing to change of address event for patients who's postcode is within the catchment area of a ICS with the ID "X2458" | Generic | ```/Bundle?type=message&amp;subscriptionRuleType=```<br/>```CHO_POSTCODE_ICS&amp;Organization.identifier=```<br/>```X2458&amp;MessageHeader.event=pds-change-of-address-1&amp;tag=site123``` |
...
<Subscription xmlns="http://hl7.org/fhir">
	...
	<reason value="Health visiting service responsible for Leeds"/>
	<criteria value="/Bundle?type=message&amp;subscriptionRuleType=CHO_POSTCODE_ICS&amp;Organization.identifier=X2458&amp;MessageHeader.event=pds-change-of-address-1" />
	<channel>
		<type value="message"/>
		<endpoint value="Mailbox1234"/>
	</channel>
