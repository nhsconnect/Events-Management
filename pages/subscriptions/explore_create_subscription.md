...
| A child health service subscribing to change of address event for patients who's postcode is within the catchment area of a CCG with the ID "X2458" | Generic | ```/Bundle?type=message&amp;subscriptionRuleType=```<br/>```CHO_POSTCODE_CCG&amp;Organization.identifier=```<br/>```X2458&amp;MessageHeader.event=pds-change-of-address-1&amp;tag=site123``` |
