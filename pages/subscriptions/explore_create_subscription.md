...
| serviceType=[CODE] | 0..1 | 0..1 | This element identifies the service type requesting the subscription. Current accepted values for explicit subscriptions are:<br/><br/>**GP** - GP Practice related services.<br/>**CHO** - Child Health Organisation related services.<br/>**UHV** - Health Visitor related services.<br/>**EPCHR** - Electronic Personal Child Health Record services.<br/> |
...
| --- | --- | --- |
| A PHR system subscribing to change of address events for a specific patient registered for a PHR | Explicit | ```/Bundle?type=message&amp;serviceType=GP&amp;Patient.identifier=http://fhir.nhs.net/Id/nhs-number|9434765919&amp;MessageHeader.event=PDS002``` |
| A child health service subscribing to events for patients who's postcode is within the catchment area of a CCG with the ID "X2458" | Generic | ```/Bundle?type=message&amp;subscriptionRuleType=CHO_POSTCODE_CCG&amp;Organization.identifier=X2458&amp;MessageHeader.event=PDS001&amp;MessageHeader.event=PDS002``` |
